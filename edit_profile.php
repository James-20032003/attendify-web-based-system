...
<?php }else{ 
 ...
 ?>le="alert">  
                ...
                <div class="input-holder">  
                    ...
                    <input type="password" name="password" class="input-1" placeholder="Old Password" required>  
                </div>  
                <div class="input-holder">  
                    <label>New Password</label>  
                    <input type="password" name="new_password" class="input-1" placeholder="New Password" required>  
                </div>  
                <div class="input-holder">  
                    <label>Confirm Password</label>  
                    <input type="password" name="confirm_password" class="input-1" placeholder="Confirm Password" required>  
                </div>  
